package com.vlascitchii.presentation_video_list.model
...
class TestVideoUIModel {
    object TestUIData {
        ...
        val TEST_UI_VIDEO_LIST = listOf(DEFAULT_VIDEO, DEFAULT_VIDEO, DEFAULT_VIDEO, DEFAULT_VIDEO)
    }
}