...
import com.vlascitchii.data_remote.model_api.video_api_model.ContentDetailsApiModel
import com.vlascitchii.data_remote.model_api.video_api_model.ThumbnailAttributesApiModel
...
import com.vlascitchii.data_remote.model_api.video_api_model.VideoStatisticsApiModel
...
private val API_VIDEO_LIST_NO_CHANNEL_IMG_URL = listOf(
...
val API_VIDEO_RESPONSE_NO_CHANNEL_IMG_URL = YoutubeVideoResponseApiModel(
    nextPageToken = "CAoQAA",
    "",
    prevPageToken = "CAUQAQ",
    items = API_VIDEO_LIST_NO_CHANNEL_IMG_URL
)

private val API_VIDEO_LIST_WITH_CHANNEL_IMG_URL = listOf(
    YoutubeVideoApiModel(
        id = "bbM6aSB6iMQ",
        "",
        snippet = VideoSnippetApiModel(
...
val API_RESPONSE_VIDEO_WITH_CHANNEL_IMG = YoutubeVideoResponseApiModel(
    nextPageToken = "CAoQAA",
    "",
    prevPageToken = "CAUQAQ",
    API_VIDEO_LIST_WITH_CHANNEL_IMG_URL
)
