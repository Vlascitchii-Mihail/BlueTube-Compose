...
private val DOMAIN_VIDEO_LIST_NO_CHANNEL_IMG_URL = listOf(
    YoutubeVideoDomain(
        id = "bbM6aSB6iMQ",
        "",
        snippet = VideoSnippetDomain(
            ...
            thumbnails = ThumbnailsDomain(
                ThumbnailAttributesDomain(
        ...
        statistics = VideoStatisticsDomain(
            400242,
            3593
        ),
        contentDetails = ContentDetailsDomain(
            "PT5M"
        )
    ),
...
val DOMAIN_VIDEO_RESPONSE_NO_CHANNEL_IMG_URL = YoutubeVideoResponseDomain(
    nextPageToken = "CAoQAA",
    "",
    prevPageToken = "CAUQAQ",
    DOMAIN_VIDEO_LIST_NO_CHANNEL_IMG_URL
)


private val DOMAIN_VIDEO_LIST_WITH_CHANNEL_IMG_URL = listOf(
    YoutubeVideoDomain(
        id = "bbM6aSB6iMQ",
        "",
        snippet = VideoSnippetDomain(
