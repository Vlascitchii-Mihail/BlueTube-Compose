...
import com.vlascitchii.data_remote.model_api.channel_api_model.ChannelContentApiModel
...
val CHANNELS: List<ChannelApiModel> = listOf(DEFAULT_CHANNEL_1, DEFAULT_CHANNEL_2, DEFAULT_CHANNEL_3, DEFAULT_CHANNEL_4, DEFAULT_CHANNEL_5)

val CHANNELS_LIST_ID: List<String> = CHANNELS.map { channel: ChannelApiModel ->
    channel.id
}
