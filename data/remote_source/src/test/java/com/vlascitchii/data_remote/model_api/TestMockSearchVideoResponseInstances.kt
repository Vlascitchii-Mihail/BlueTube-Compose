...
import com.vlascitchii.data_remote.model_api.search_api_model.SearchVideoItemIdApiModel
import com.vlascitchii.data_remote.model_api.search_api_model.SearchVideoResponseApiModel

private val API_RESPONSE_SEARCH_VIDEO_LIST_NO_CHANNEL_URL = listOf(
...
val API_RESPONSE_SEARCH_VIDEO_NO_CHANNEL_URL = SearchVideoResponseApiModel(
    nextPageToken = "CAoQAA",
    prevPageToken = "CAUQAQ",
    API_RESPONSE_SEARCH_VIDEO_LIST_NO_CHANNEL_URL
)


private val API_RESPONSE_SEARCH_VIDEO_LIST_WITH_CHANNEL_IMG_URL = listOf(
    SearchVideoItemApiModel(
        SearchVideoItemIdApiModel(videoId = "bbM6aSB6iMQ"),
        snippet = VideoSnippetApiModel(
            "State of Origin 2024 | Blues v Maroons | Match Highlights",
...
val API_RESPONSE_SEARCH_VIDEO_WITH_CHANNEL_IMG_URL = SearchVideoResponseApiModel(
    nextPageToken = "CAoQAA",
    prevPageToken = "CAUQAQ",
    API_RESPONSE_SEARCH_VIDEO_LIST_WITH_CHANNEL_IMG_URL
)