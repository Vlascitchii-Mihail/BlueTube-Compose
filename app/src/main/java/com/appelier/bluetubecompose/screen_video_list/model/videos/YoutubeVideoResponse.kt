...
data class YoutubeVideoResponse(
    ...
    companion object {
        ...
        val DEFAULT_VIDEO_RESPONSE = YoutubeVideoResponse(
        ...
        const val INITIAL_PAGE = "Initial page"


        val DEFAULT_VIDEO_RESPONSE_WITH_CHANNEL_IMG = YoutubeVideoResponse(
            nextPageToken = "CAoQAA",
            "",
            prevPageToken = "CAUQAQ",
        ...
        val TEST_DATABASE_VIDEO_RESPONSE = YoutubeVideoResponse(
            nextPageToken = "CAoQAA",
            INITIAL_PAGE,
            prevPageToken = "CAUQAQ",
