...
class RepositoryModule {
    ...
    fun provideShortsRepository(
        ...
        localVideoListDataSource: LocalVideoListDataSource,
        customCoroutineScope: CustomCoroutineScope
    ): ShortsRepository = ShortsRepositoryImpl(remoteShortsDataSource, localVideoListDataSource, customCoroutineScope)
    ...
    fun providePlayerRepository(
        ...
        localVideoListDataSource: LocalVideoListDataSource,
        customCoroutineScope: CustomCoroutineScope
    ): PlayerRepository = PlayerRepositoryImpl(remoteSearchDataSource, localVideoListDataSource, customCoroutineScope)
}
