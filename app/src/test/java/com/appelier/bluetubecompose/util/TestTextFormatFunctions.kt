...
class TestTextFormatFunctions {
    ...
    @Test
    fun testFormatDate() {
        assertEquals("2 minutes ago", formatDate(currentMinutes))
        assertEquals("2 hours ago", formatDate(currentHours))
        assertEquals("2 days ago", formatDate(currentDays))
        assertEquals("3 months ago", formatDate(currentMonths))
        assertEquals("7 years ago", formatDate("2017-01-22T21:08:03Z"))
    }
